...
pfinal_data_bundle get_co2_data_obj(pfinal_data_bundle self);
pfinal_data_bundle get_light_data_obj(pfinal_data_bundle self);
pfinal_data_bundle get_temp_hum_data_obj(pfinal_data_bundle self);
